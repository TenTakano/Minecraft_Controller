defmodule MinecraftControllerWeb.ChannelCase do
  @moduledoc """
  ...
  by setting `use MinecraftControllerWeb.ChannelCase, async: true`, although
  ...
  using do
    quote do
      ...
      import MinecraftControllerWeb.ChannelCase
